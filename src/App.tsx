    ...
    <div dir={lang === "ar" ? "rtl" : "ltr"}>
      <header>
        ...
        <div className="bar">
          ...
          <a
            href="https://github.com/Ezarwebmaster/WC26"
            target="_blank"
            rel="noreferrer"
          ...
          >
            <svg
              ...
              style={{ display: "block" }}
            >
              <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-2.11-.24-4.32-1.05-4.32-4.68 0-1.03.37-1.87 1.02-2.54-.1-.24-.44-1.2.1-2.51 0 0 .79-.25 2.61.97.75-.21 1.55-.32 2.35-.32.8 0 1.6.11 2.35.32 1.81-1.23 2.6-1.97 2.6-1.97.54 1.31.2 2.27.1 2.51.65.67 1.02 1.51 1.02 2.54 0 4.25-2.22 4.67-4.33 4.91.4.35.75 1.04.75 2.1 0 1.52-.01 2.75-.01 3.12 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z" />
            </svg>
            GitHub
          </a>
